        ...
        <div class="max-w-7xl mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-3">
                    ...
                    <span class="text-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">DocAnalysis AI</span>
                </div>
    ...
    <footer class="bg-gray-900 text-gray-400 py-12 px-6">
        <div class="max-w-7xl mx-auto text-center">
            <div class="flex items-center justify-center space-x-3 mb-4">
                ...
                <span class="text-lg font-bold text-white">DocAnalysis AI</span>
            </div>
            ...
            <p class="text-xs mt-2">© 2026 DocAnalysis AI. All rights reserved.</p>
        </div>
    </footer>
</body>
</html>
